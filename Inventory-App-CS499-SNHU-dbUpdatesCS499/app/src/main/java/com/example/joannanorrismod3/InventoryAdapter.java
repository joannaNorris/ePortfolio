...
public class InventoryAdapter extends RecyclerView.Adapter<InventoryAdapter.InventoryViewHolder> {
    ...
    //constructor
    public InventoryAdapter(Context context, Cursor cursor, OnItemDeleteListener listener, OnUpdateQtyListener updateQtyListener, OnViewItemListener viewListener) {
    ...
    public interface OnViewItemListener {
        void onViewItem(int itemId, String name, String sku, int quantity, String description, String supplierContact);
    }
    ...
    public void onBindViewHolder(@NonNull InventoryViewHolder holder, int position) {
        ...
        String category = cursor.getString(cursor.getColumnIndexOrThrow(
                InventoryDatabaseHelper.COL_CAT_NAME));
        String supplier = cursor.getString(cursor.getColumnIndexOrThrow(
                InventoryDatabaseHelper.COL_SUP_NAME));
        String description = cursor.getString(cursor.getColumnIndexOrThrow(
                InventoryDatabaseHelper.COL_DESC));
        String supplierContact = cursor.getString(cursor.getColumnIndexOrThrow(
                InventoryDatabaseHelper.COL_SUP_CONTACT));
        ...
        holder.btnViewItem.setOnClickListener(v -> {
            if(viewListener != null) {
                viewListener.onViewItem(id, name, sku, quantity, description, supplierContact);
            }
        });
    }
